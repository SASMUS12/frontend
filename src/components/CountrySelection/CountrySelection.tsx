  ...
  const handleRemoveCountry = (country: Country) => {
    ...
    return (
        <div className={styles.country}>
            <Input
                className={`${styles.country__input} ${isCountryListVisible ? styles.country__input_showSuggestions : ''}`}
                type="search"
                name="country"
                value={searchValue}
            ...
            <div className={styles.country__selectedCountries}>
                ...
                {isCountryListVisible && (
                    <div className={classNames(styles.country__countryList, {
                        [styles.country__countryList_visible]: sortCountriesByLastLetter().length > 0,
                    })}
