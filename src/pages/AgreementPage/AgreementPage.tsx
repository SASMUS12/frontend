    ...
    <>
      ...
      <main className={styles.content}>
        ...
        <div className={styles.content__textBlock}>
          <p>
            Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между владельцем <span> https://lingvogo.acceleratorpracticum.ru/</span> (далее <span>https://lingvogo.acceleratorpracticum.ru/ </span>или Администрация) с одной стороны и пользователем сайта с другой.
          </p>
          <p>
            Сайт <span>https://lingvogo.acceleratorpracticum.ru/</span> не является средством массовой информации.
          </p>
          <p>
            Используя сайт, Вы соглашаетесь с условиями данного соглашения. Если Вы не согласны с условиями данного соглашения, не используйте сайт <span>https://lingvogo.acceleratorpracticum.ru/</span>!
          </p>
          <h3>
            Предмет соглашения
          </h3>
