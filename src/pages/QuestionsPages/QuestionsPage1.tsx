            ...
            <main className={styles.content}>
                <div className={styles.container}>
                    ...
                    <QuestionArea>
                        ...
                        <Gender selectedGender={selectedGender} setSelectedGender={setSelectedGender} componentName="questions" />
                    </QuestionArea>
                    <QuestionArea>
                        <Input
                            className={styles.container__questionArea_input}
                    ...
                    <QuestionArea>
                        <h3 className={styles.container__questionArea_title}>Загрузите фото или создайте аватар</h3>
                        <p className={styles.container__questionArea_hint}>Пожалуйста, используйте форматы JPG и PNG</p>
                        <div className={styles.container__questionArea_exportAvatar}>
                            <div className={styles.container__questionArea_exportAvatar_popup}>
                                <button onClick={() => handleAvatarSelection('Загрузить')}>Загрузить фотографию</button>
                    ...
                    <Modal className={styles.modal} isOpen={isExportAvatarModal} onClose={handleModalClose}>
                        ...
                        <p className={styles.modal__text}>
                            Партнёрам будет приятнее вести диалог, если&nbsp;Вы&nbsp;загрузите свою настоящую фотографию. Пожалуйста, используйте форматы JPG и PNG.
                        </p>
                        <Button
