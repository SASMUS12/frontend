import {ChangeEvent, FormEvent, MouseEventHandler, useEffect, useMemo, useState} from "react";
...
const FillOutProfilePage4 = () => {
        ...
        const [selectedGoals, setSelectedGoals] = useState<{
            image: string, name: string, description: string, active: boolean
        }[]>([]);
        ...
        const handleGoalButtonClick = (event, goal, index) => {
            ...
            if (!goal.active) {
                ...
                goal.active = false;
                const updatedGoals = selectedGoals.filter((selectedGoal) => selectedGoal.active);
                setSelectedGoals(updatedGoals);
