      ...
      <main className={styles.content}>
        ...
        <div className={styles.content__textBlock}>
          ...
          <p>
            ...
            ресурсом LingvogoChat (далее — Оператор).
          </p>
          <p>
          ...
          <p>
            ...
            https://lingvogo.acceleratorpracticum.ru/.
          </p>
          ...
          <p>
            ...
            материалам, содержащимся на веб-сайте, и заполнение профиля
            Пользователя (персональные данные: электронный адрес, год, месяц,
            дата и место рождения, фотографии, имя, пол).
          </p>
          ...
          <p>
            ...
            Оператора linguachat@ro.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p>
          ...
          <p>
            ...
            linguachat@ro.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <p>
          ...
          <p>
            ...
            к Оператору с помощью электронной почты linguachat@ro.ru.
          </p>
          <p>
          ...
          <p>
            ...
            https://lingvogo.acceleratorpracticum.ru/policy.
          </p>
        </div>
      </main>
      <Footer />
